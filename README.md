# Tableau Public Profile - Pranav Padmannavar
...
## [Visit My Tableau Public Profile](https://public.tableau.com/app/profile/pranav.padmannavar/vizzes)
...
## About Me
I am Pranav Padmannavar, a Master of Science in Analytics student at the University of Minnesota. I have a strong background in data analytics, data science, and business intelligence, with professional experience as a Data Analyst at Tata Consultancy Services and a Data Science Intern at Daikin Applied. My expertise lies in transforming raw data into meaningful insights and compelling visual narratives. I use Tableau and other tools to create dynamic dashboards and interactive reports that aid in decision-making and strategic planning.
...
- **Link**: [IMDb Movie Dashboard](https://public.tableau.com/views/IMDbMovieDashboard_17627341409670/IMDbMovieDashboard?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
...
  - Analysis of genre popularity over time
- **Link**: [Netflix Movie Analytics](https://public.tableau.com/views/Netflix_17627342414270/Netflix?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
...
- **Link**: [Heart Failure Data Analysis](https://public.tableau.com/views/Heartfailure_17627340496090/Dashboard1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)

## Skills

* **Data Visualization:** Tableau, Power BI, Matplotlib, Seaborn, Data Storytelling
* **Data Analysis & Manipulation:** Advanced SQL, Python (Pandas, NumPy), R, PySpark
* **Statistics & Modeling:** Predictive Analytics, A/B Testing, Hypothesis Testing, Machine Learning (Scikit-learn, TensorFlow)
* **Databases & Cloud:** PostgreSQL, MySQL, Microsoft Azure, AWS, GCP (BigQuery)

## Contact

Feel free to connect with me on [LinkedIn](https://www.linkedin.com/in/pranavsp108/) or reach out via [email](mailto:padma062@umn.edu). I am always open to discussing new projects, collaborations, suggestions or opportunities in the field of data analytics and visualization.
